...
namespace Reflector.CodeModel
{
    ...
    internal class InstructionHelper
    {
        ...
        public static string GetOpCodeFieldName(int code)
        {
            ...
            {
                codes = new Hashtable();
                Type opCodesType = typeof(System.Reflection.Emit.OpCodes);
                foreach (System.Reflection.FieldInfo field in opCodesType.GetFields())
                {
                    if (field.FieldType == typeof(System.Reflection.Emit.OpCode))
                    {
                        System.Reflection.Emit.OpCode op = (System.Reflection.Emit.OpCode)field.GetValue(null);
                        codes.Add(op.Value, field.Name);
                    }
                }
            }
