...
namespace LiveSequence.Tree
{
    ...
    public class DTreeEventArgs<T> : EventArgs
    {
        ...
        private readonly DTreeNode<T> _node;
    ...
    {
        private readonly DTreeNode<T> mRoot;
    ...
    public class DTreeNode<T>
    {
        #region Node Data
        private T mValue;
        private DTreeNode<T> mParent;
        private DTreeNodeCollection<T> mNodes;
        private DTreeRoot<T> mRoot;
        #endregion // Node Data
          ...
          : System.Collections.CollectionBase, IEnumerable<DTreeNode<T>>
    {
        ...
        private readonly DTreeNode<T> mOwner;
